...
class Generator(object):
    ...
    def Generate(self, sampling_list=None):
        ...
        for start, end in cuts:
            ...
            self.inputs, self.target_lanes, self.target_h, self.test_image, self.data_list = self.Resize_data(start,
                                                                                                              end,
                                                                                                              sampling_list)
            ...
            yield self.inputs / 255.0, self.target_lanes, self.target_h, self.test_image / 255.0, self.data_list, len(cuts)  # generate normalized image
    ...
    def Rotate(self):
        ...
        for i in indices:
            ...
            for j in range(len(x)):
                ...
                x[j][index_mask], y[j][index_mask] = Rotate_Points((self.p.x_size // 2, self.p.y_size // 2),
